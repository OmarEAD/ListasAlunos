...
6. Uma caixa contém 5 bolas azuis e 2 pretas. Suponha um experimento que consiste em retirar duas bolas sucessivamente sem reposição. Seja uma variável aleatória $X$: "número de bolas azuis extraídas no experimento". Construa a distribuição de probabilidades de $X$.

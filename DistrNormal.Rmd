...
```{r fig-gauss, echo=FALSE, fig.cap='Representação de uma curva em forma de sino (a área sob a curva não é um). Essa curva é dada pela função $f(x)= e^{(ax^{2} + bx + c)}$, em que $a=-2$, $b=0$ e $c=1$.', tidy=FALSE}
x <- seq(-2,2,0.01)
a <- -2
b <- 0
c <- 1

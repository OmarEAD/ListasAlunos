...
Se quisermos que esta função tenha um máximo, precisamos fazer $a<0$. Assim $a=- \alpha$ com $\alpha > 0$. As constantes $b$, a qual move o pico central da distribuição ao longo de $x$, e $c$ são escolhidas a fim de que
